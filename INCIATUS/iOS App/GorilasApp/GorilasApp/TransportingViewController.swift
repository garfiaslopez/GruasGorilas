//
//  TransportingViewController.swift
//  GorilasApp
//
...
class TransportingViewController: UIViewController, UITableViewDelegate, UITableViewDataSource , CLLocationManagerDelegate, GMSMapViewDelegate  {
    ...
    override func viewDidLoad() {
        ...
        self.Timer = Foundation.Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(TransportingViewController.drawOriginMarker), userInfo: nil, repeats: false);
        RunLoop.main.add(self.Timer, forMode: RunLoopMode.commonModes);
        

        
        if (self.Order.destiny.address != "Sin direccion" && self.Order.destiny.address != "") {
            self.DrawMarker(self.Order.destiny.lat, Long: self.Order.destiny.long, title: "Destino");
        }
    ...
    func drawOriginMarker() {
        ...
        self.Timer = Foundation.Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(TransportingViewController.FocusMapOnAllMarkers), userInfo: nil, repeats: false);
        RunLoop.main.add(self.Timer, forMode: RunLoopMode.commonModes);
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        tracker.set(kGAIScreenName, value: "User_Transporting")
